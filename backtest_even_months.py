...
"""
================================================================================
BACKTEST ON EVEN MONTHS 2025 - Current Configuration
================================================================================
Tests current configuration on Feb, Apr, Jun, Aug, Oct, Dec 2025
================================================================================
"""
...
# Even months of 2025
PERIODS = [
    ('February', datetime(2025, 2, 1), datetime(2025, 2, 28, 23, 59, 59)),
    ('April', datetime(2025, 4, 1), datetime(2025, 4, 30, 23, 59, 59)),
...
def run_backtest():
    """Run backtest on even months of 2025"""
    
    print("="*80)
    print("BACKTEST: Current Config on Even Months 2025")
    print("="*80)
    print("Testing: February, April, June, August, October, December")
    print("="*80)
    ...
    # Save to CSV
    csv_filename = "backtest_even_months_2025.csv"
    ...
    print("\n" + "="*80)
    print("SYMBOL PERFORMANCE (Across All Even Months)")
    print("="*80)
